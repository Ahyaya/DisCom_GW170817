...
int main()
{
	...
	printf("Welcome to use Likelihood Estimation (Mq)\n========================================\n\nDistributed Computation Part 5\n\n");

	Pout=fopen("Prior_Results_p5.txt","w");
	Dataout=fopen("Prior_InternalData_p5.txt","w");
	strucpfout=fopen("Prior_DataStrucPf_p5","w");
	printf("Initiating EoS generator...\n");
	PtInitial();
	printf("Loading mass frames...\n");
	loadMassSeq();
	printf("\nComputing...\n\n");
	for(J0=320;J0<401;J0=J0+4)
	{
